...
\begin{minipage}[t]{0.5\textwidth}
  ...
  Science Building \\
  3581 Cullen Boulevard Suite 230 \\
...
\item Teaching Assistant, Intermediate Macroeconomics and  Capital Market

\qquad  Economics, Islam Rizvanoghlu, August 2018--August 2019.
%\item Research Assistant,
...
\begin{itemize}
\item "Democratic Institutions and Their Effect on Ethnic Favoritism: Evidence from Sub Saharan Africa"
\end{itemize}
...
{Working Group in African Political Economy}, University of  California, Berkeley
\end{description}
%
%\item Referee for:
%  \begin{itemize}
...
\subsection*{Alex T for Congress}
\begin{itemize}
...
\item \href{https://www.pbk.org/}{The Phi Beta Kappa Society, 2017--Present}
\item \href{http://www.goldenkey.org}{Golden Key International Honour Society, 2012--Present}.
